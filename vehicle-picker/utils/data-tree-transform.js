...
const dataURL = "https://gist.githubusercontent.com/leetrout/06691832f46d91ea0d533b5280467491/raw/cca39786bcddd93a4aebe88ade03b5c9f33b1fb0/vehicle_flat_pretty.json"
;
...
function makeTree(fullData) {
  ...
  fullData.forEach((r) => {
    const strYear = String(r.year); /* makes the year into a string*/
